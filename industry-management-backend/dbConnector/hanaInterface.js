...
class HdbInterface {
    ...
    selectProductsForTenant(callback) {
        ...
        hdbext.createConnection(this.hanaConfig, (err, client) => {
            ...
            client.exec('select product_id as "product_id", product_name as "product_name", product_description as "product_description", supplier_name as "supplier_name", price as "price", available as "available", quantity as "quantity" from "business::PRODUCTS"', (err, res) => {
                if (err) {
